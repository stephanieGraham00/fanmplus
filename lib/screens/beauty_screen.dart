...
class _BeautyScreenState extends State<BeautyScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _recipe = BeautyService.randomRecipe;
    _animCtrl.forward();
  }
  ...
  void _newRecipe() {
    _animCtrl.reset();
    setState(() => _recipe = BeautyService.randomRecipe);
    _animCtrl.forward();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: const BoxDecoration(gradient: LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Color(0xFFFCE4EC), Color(0xFFF3E8FF)])),
      child: Scaffold(
        backgroundColor: Colors.transparent,
        appBar: AppBar(title: const Text('🌸 Belte Natirèl')),
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: const LinearGradient(colors: [Color(0xFFF8BBD0), Color(0xFFE1BEE7)]),
                    borderRadius: BorderRadius.circular(28),
                    boxShadow: [BoxShadow(color: Colors.pink.withOpacity(0.3), blurRadius: 20, offset: const Offset(0, 8))],
                  ),
                  child: Column(
                    children: [
                      Text(['🌸', '💄', '🧴', '✨', '🌿', '🫧'][_recipe.hashCode % 6], style: const TextStyle(fontSize: 64)),
                      const SizedBox(height: 12),
                      Text(name.replaceAll('🌸 ', ''), style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white), textAlign: TextAlign.center),
                    ],
                  ),
                ),
                  ...
                  children: [
                    Material(
                      ...
                      child: InkWell(
                        borderRadius: BorderRadius.circular(24),
                        onTap: _newRecipe,
                        child: const Padding(padding: EdgeInsets.symmetric(horizontal: 24, vertical: 12), child: Row(mainAxisSize: MainAxisSize.min, children: [Icon(Icons.refresh, color: Colors.pink), SizedBox(width: 6), Text('Yon lòt', style: TextStyle(color: Colors.pink, fontWeight: FontWeight.w600))])),
                      ),
                    ),
                    ...
                    Material(
                      ...
                      child: InkWell(
                        borderRadius: BorderRadius.circular(24),
                        onTap: () => _shareWhatsApp('Fanm+ 🌸 Belte Natirèl\n\n$_recipe\n\n${AppConstants.copyright}'),
